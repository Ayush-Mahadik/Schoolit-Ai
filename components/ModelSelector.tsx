      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-1.5 w-64 bg-surface-2 border border-blue-500/20 rounded-xl shadow-2xl z-[100] overflow-hidden"
          >
            <div className="p-1.5">
              <p className="text-[10px] uppercase tracking-wider text-blue-500/50 font-bold px-2.5 py-1.5">
                AI Model
              </p>
